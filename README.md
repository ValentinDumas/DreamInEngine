...
A 2D/3D Game Engine made in C++ with OpenGL, SFML and ImGUI.
The goal of this project is to allow future users to create simple and entertaining 2D/3D games, supporting this Game Engine.
Note that DreamInEngine is a cross-platform game engine.
...
[![codecov](https://codecov.io/gh/ValentinDumas/DreamInEngine/branch/master/graph/badge.svg)](https://codecov.io/gh/ValentinDumas/DreamInEngine)
...
-   The name of the project
        ...
        PROJECT_NAME           = "DreamInEngine"

-   A quick description of the project

        PROJECT_BRIEF          = "2D/3D C++ game engine"
...
It is available at: [https://codedocs.xyz/ValentinDumas/DreamInEngine](https://codedocs.xyz/ValentinDumas/DreamInEngine/)
...
-   Inside the IDE, search for "DreamInEngine" and replace all occurences by the project name of your choice.
